...
try {
    ...
    $month = $_GET['view'];
    if($month === "month_1"){$background = "blog_template_1_1_month"; $pageName = "level_1_1_month";}
    elseif($month === "month_2"){$background = "blog_template_1_2_month"; $pageName = "level_1_2_month";}
    elseif($month === "month_3"){$background = "blog_template_1_3_month"; $pageName = "level_1_3_month";}
    elseif($month === "month_4"){$background = "blog_template_1_4_month"; $pageName = "level_1_4_month";}
...
<?php
    ...
    $mpdf->Output("النخبة - الشهر $monthName (مستوى السنة النبوية).pdf", 'I');
