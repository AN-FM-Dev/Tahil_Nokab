...
try {
    ...
    $week = $_GET['view'];
    if($week === "week_1"){$background = "template_7_3_1"; $pageName = "level_3_1";}
    elseif($week === "week_2"){$background = "template_7_3_2"; $pageName = "level_3_2";}
    elseif($week === "week_3"){$background = "template_7_3_3"; $pageName = "level_3_3";}
    elseif($week === "week_4"){$background = "template_7_3_4"; $pageName = "level_3_4";}
    elseif($week === "week_5"){$background = "template_7_3_5"; $pageName = "level_3_5";}
    elseif($week === "week_6"){$background = "template_7_3_6"; $pageName = "level_3_6";}
    elseif($week === "week_7"){$background = "template_7_3_7"; $pageName = "level_3_7";}
    elseif($week === "week_8"){$background = "template_7_3_8"; $pageName = "level_3_8";}
    elseif($week === "week_9"){$background = "template_7_3_9"; $pageName = "level_3_9";}
    elseif($week === "week_10"){$background = "template_7_3_10"; $pageName = "level_3_10";}
    elseif($week === "week_11"){$background = "template_7_3_11"; $pageName = "level_3_11";}
    elseif($week === "week_12"){$background = "template_7_3_12"; $pageName = "level_3_12";}
    elseif($week === "week_13"){$background = "template_7_3_13"; $pageName = "level_3_13";}
    elseif($week === "week_14"){$background = "template_7_3_14"; $pageName = "level_3_14";}
...
<head>
  <meta charset="utf-8">
   ...
   <title>نخب 7 | الأسبوع <?= $weekName; ?></title>
...
<?php
    ...
    $mpdf->Output("نخب 7 - الأسبوع $weekName.pdf", 'I');
