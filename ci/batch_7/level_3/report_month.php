...
try {
    ...
    $month = $_GET['view'];
    if($month === "month_1"){$background = "template_7_3_1_month"; $pageName = "level_3_1_month";}
    elseif($month === "month_2"){$background = "template_7_3_2_month"; $pageName = "level_3_2_month";}
    elseif($month === "month_3"){$background = "template_7_3_3_month"; $pageName = "level_3_3_month";}
    ...
    if ($pageName === "level_3_1_month") {$monthName = 'الأول';}
    elseif ($pageName === "level_3_2_month") {$monthName = 'الثاني';}
    elseif ($pageName === "level_3_3_month") {$monthName = 'الثالث';}
?>
...
<head>
  <meta charset="utf-8">
   ...
   <title>نخب 7 | الشهر <?= $monthName; ?></title>
</head>
<body>
...
<?php
    ...
    $mpdf->Output("نخب 7 - الشهر $monthName.pdf", 'I');
