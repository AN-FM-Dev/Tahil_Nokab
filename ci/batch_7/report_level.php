...
try {
    ...
    <?php
    $level = $_GET['view'];
    if($level === "level_1"){$background = "template_7_1"; $tops = "tops_7_1"; $pageName = "report_v_1";}
    elseif($level === "level_2"){$background = "template_7_2"; $tops = "tops_7_2"; $pageName = "report_v_2";}
    elseif($level === "level_3"){$background = "template_7_3"; $tops = "tops_7_3"; $pageName = "report_v_3";}
    elseif($level === "all_level"){$background = "template_7"; $tops = "tops_7"; $pageName = "report_v";}
    ...
    elseif ($pageName === "report_v") {$levelName = 'كامل';}
...
<head>
    ...
    <title>نخب 7 | التقرير الاجمالي للمستوى <?= $levelName; ?></title>
</head>
<body>
...
<?php    
    ...
    $mpdf->Output("نخب 7 - التقرير الاجمالي [المستوى $levelName].pdf", 'I');
