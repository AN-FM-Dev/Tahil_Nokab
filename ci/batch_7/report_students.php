...
try {
    ...
    $level = $_GET['view'];
    if($level === "level_1"){$background = "template_7_1_s_2"; $coverBackground = "template_7_1_s_1"; $pageName = "report_v_s_1";}
    elseif($level === "level_2"){$background = "template_7_2_s_2"; $coverBackground = "template_7_2_s_1"; $pageName = "report_v_s_2";}
    elseif($level === "level_3"){$background = "template_7_3_s_2"; $coverBackground = "template_7_3_s_1"; $pageName = "report_v_s_3";}
...
<head>
    ...
    <title>نخب 7 | التقرير التفصيلي للمستوى <?= $levelName; ?></title>
</head>
<body>
...
<?php
    ...
    $mpdf->Output("نخب 7 - التقرير التفصيلي [المستوى $levelName].pdf", 'I');
