...
try {
    ...
    $month = $_GET['view'];
    if($month === "month_1"){$background = "template_8_2_1_month"; $pageName = "level_2_1_month";}
    elseif($month === "month_2"){$background = "template_8_2_2_month"; $pageName = "level_2_2_month";}
    elseif($month === "month_3"){$background = "template_8_2_3_month"; $pageName = "level_2_3_month";}
    ...
    if ($pageName === "level_2_1_month") {$monthName = 'الأول';}
    elseif ($pageName === "level_2_2_month") {$monthName = 'الثاني';}
    elseif ($pageName === "level_2_3_month") {$monthName = 'الثالث';}
?>
