...
try {
    ...
    $month = $_GET['view'];
    if($month === "month_1"){$background = "template_8_3_1_month"; $pageName = "level_3_1_month";}
    elseif($month === "month_2"){$background = "template_8_3_2_month"; $pageName = "level_3_2_month";}
    elseif($month === "month_3"){$background = "template_8_3_3_month"; $pageName = "level_3_3_month";}
...
<?php
    ...
    $mpdf->Output("نخب - الشهر $monthName (الثانوي).pdf", 'I');
