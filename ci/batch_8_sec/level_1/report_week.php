...
try {
    ...
    $week = $_GET['view'];
    if($week === "week_1"){$background = "template_8_1_1"; $pageName = "level_1_1";}
    elseif($week === "week_2"){$background = "template_8_1_2"; $pageName = "level_1_2";}
    elseif($week === "week_3"){$background = "template_8_1_3"; $pageName = "level_1_3";}
    elseif($week === "week_4"){$background = "template_8_1_4"; $pageName = "level_1_4";}
    elseif($week === "week_5"){$background = "template_8_1_5"; $pageName = "level_1_5";}
    elseif($week === "week_6"){$background = "template_8_1_6"; $pageName = "level_1_6";}
    elseif($week === "week_7"){$background = "template_8_1_7"; $pageName = "level_1_7";}
    elseif($week === "week_8"){$background = "template_8_1_8"; $pageName = "level_1_8";}
    elseif($week === "week_9"){$background = "template_8_1_9"; $pageName = "level_1_9";}
    elseif($week === "week_10"){$background = "template_8_1_10"; $pageName = "level_1_10";}
    elseif($week === "week_11"){$background = "template_8_1_11"; $pageName = "level_1_11";}
    elseif($week === "week_12"){$background = "template_8_1_12"; $pageName = "level_1_12";}
    elseif($week === "week_13"){$background = "template_8_1_13"; $pageName = "level_1_13";}
    elseif($week === "week_14"){$background = "template_8_1_14"; $pageName = "level_1_14";}
    ...
    elseif ($pageName === "level_1_11") {$weekName = 'الأول';}
    elseif ($pageName === "level_1_12") {$weekName = 'الأول';}
    elseif ($pageName === "level_1_13") {$weekName = 'الأول';}
    elseif ($pageName === "level_1_14") {$weekName = 'الأول';}
?>
