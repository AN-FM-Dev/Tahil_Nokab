...
try {
    ...
    $test = $_GET['view'];
    if($test === "test_h_1"){$background = "uni_template_1_1_test_h"; $pageName = "level_1_1_test_h"; $name = "الحفظ";}
    elseif($test === "test_h_2"){$background = "uni_template_1_2_test_h"; $pageName = "level_1_2_test_h"; $name = "الحفظ";}
    elseif($test === "test_h_3"){$background = "uni_template_1_3_test_h"; $pageName = "level_1_3_test_h"; $name = "الحفظ";}
    elseif($test === "test_h_4"){$background = "uni_template_1_4_test_h"; $pageName = "level_1_4_test_h"; $name = "الحفظ";}
    elseif($test === "test_t_1"){$background = "uni_template_1_1_test_t"; $pageName = "level_1_1_test_t"; $name = "التفهم";}
    elseif($test === "test_t_2"){$background = "uni_template_1_2_test_t"; $pageName = "level_1_2_test_t"; $name = "التفهم";}
    elseif($test === "test_t_3"){$background = "uni_template_1_3_test_t"; $pageName = "level_1_3_test_t"; $name = "التفهم";}
    elseif($test === "test_t_4"){$background = "uni_template_1_4_test_t"; $pageName = "level_1_4_test_t"; $name = "التفهم";}
...
<?php
    ...
    $mpdf->Output("نخب - اختبار الحفظ $test_hName (جامعي).pdf", 'I');
