...
try {
    ...
    $month = $_GET['view'];
    if($month === "month_1"){$background = "uni_template_1_1_month"; $pageName = "level_1_1_month";}
    elseif($month === "month_2"){$background = "uni_template_1_2_month"; $pageName = "level_1_2_month";}
    elseif($month === "month_3"){$background = "uni_template_1_3_month"; $pageName = "level_1_3_month";}
    elseif($month === "month_4"){$background = "uni_template_1_4_month"; $pageName = "level_1_4_month";}
...
<?php
    ...
    $mpdf->Output("نخب - الشهر $monthName (جامعي).pdf", 'I');
