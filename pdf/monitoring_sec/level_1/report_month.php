...
try {
    ...
    $month = $_GET['view'];
    if($month === "month_1"){$background = "sec_template_1_1_month"; $pageName = "level_1_1_month";}
    elseif($month === "month_2"){$background = "sec_template_1_2_month"; $pageName = "level_1_2_month";}
    elseif($month === "month_3"){$background = "sec_template_1_3_month"; $pageName = "level_1_3_month";}
    elseif($month === "month_4"){$background = "sec_template_1_4_month"; $pageName = "level_1_4_month";}
